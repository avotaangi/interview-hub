...
class ResumeAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ('candidate', 'desired_position', 'desired_salary', 'short_skills', 'short_job_experiences', 'created_at')
    ...
    def short_job_experiences(self, obj):
        ...
        """
        return ', '.join(
            [job.company for job in obj.job_experiences.all()[:3]]) if obj.job_experiences.exists() else 'No experiences provided'
